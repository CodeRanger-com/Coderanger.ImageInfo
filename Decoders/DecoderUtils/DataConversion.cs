...
internal static class DataConversion
{
  ...
  internal static short Int16FromBuffer( byte[] buffer, int offset, ByteOrder bufferOrder )
  {
  ...
  /// <returns>Converted Int16 or short</returns>
  /// <exception cref="ArgumentException">Thrown if buffer is not big enough</exception>
  internal static int Int32FromBuffer( byte[] buffer, int offset, ByteOrder bufferOrder )
  {
    if( bufferOrder == ByteOrder.BigEndian )
    {
  ...
  /// <summary>
  /// Convert data from buffer determined by the buffer order, into a 8 byte 64bit
  /// signed long (Int64)
  /// </summary>
  /// <param name="buffer">Buffer whose size is at least 2 bytes bigger than the offset given</param>
  /// <param name="offset">Offset from start of buffer to start conversion</param>
  ...
  /// <returns>Converted Int16 or short</returns>
  /// <exception cref="ArgumentException">Thrown if buffer is not big enough</exception>
  internal static long Int64FromBuffer( byte[] buffer, int offset, ByteOrder bufferOrder )
  {
    if( bufferOrder == ByteOrder.BigEndian )
    {
